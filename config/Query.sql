...
('ACTIVE','EXPIRED','SUSPENDED') NOT NULL DEFAULT 'EXPIRED',
  `eRole` enum
('ADMIN','TRAINER','MEMBER', 'USER') NOT NULL DEFAULT 'MEMBER',
  `status` enum
...
(255) NOT NULL,
  `eRole` enum
('ADMIN','TRAINER','MEMBER', 'USER') NOT NULL DEFAULT 'ADMIN',
  `status` enum
('ACTIVE','INACTIVE') NOT NULL DEFAULT 'ACTIVE',
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp
(),
...
UPDATE current_timestamp(),
  PRIMARY KEY
(`id`),
  UNIQUE KEY `unique_admin_username`
(`username`),
  UNIQUE KEY `unique_admin_email`
(`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(255) NOT NULL,
  `eRole` enum
('ADMIN','TRAINER','MEMBER', 'USER') NOT NULL DEFAULT 'TRAINER',
  `status` enum
('ACTIVE','INACTIVE') NOT NULL DEFAULT 'ACTIVE',
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp
(),
...
UPDATE current_timestamp(),
  PRIMARY KEY
(`id`),
  UNIQUE KEY `unique_trainer_username`
(`username`),
  UNIQUE KEY `unique_trainer_email`
(`email`),
  UNIQUE KEY `unique_trainer_phone`
(`phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(15,2) NOT NULL,
  `paymentMethod` enum
('CASH_ON_DELIVERY','QR_TRANSFER') NOT NULL,
  `qrImage` varchar
(255) DEFAULT NULL,
  `refNo` varchar
(255) DEFAULT NULL,
  `paymentStatus` enum
('PENDING','COMPLETED','FAILED','REFUNDED') NOT NULL DEFAULT 'PENDING',
...
(11) DEFAULT 0,
  `status` enum
('ACTIVE','EXPIRED','FROZEN','CANCELLED') NOT NULL DEFAULT 'ACTIVE',
  `paymentId` int
(11) NOT NULL,
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp
(),
...
(`packageId`),
  KEY `paymentId`
(`paymentId`),
  CONSTRAINT `membership_registrations_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `users`
(`id`),
  CONSTRAINT `membership_registrations_ibfk_2` FOREIGN KEY
(`packageId`) REFERENCES `membership_packages`
(`id`),
  CONSTRAINT `membership_registrations_ibfk_3` FOREIGN KEY
...
(11) NOT NULL,
  `status` enum
('ACTIVE','COMPLETED','EXPIRED','CANCELLED') NOT NULL DEFAULT 'ACTIVE',
  `paymentId` int
(11) NOT NULL,
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp
(),
...
(`packageId`),
  KEY `paymentId`
(`paymentId`),
  CONSTRAINT `pt_registrations_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `users`
(`id`),
  CONSTRAINT `pt_registrations_ibfk_2` FOREIGN KEY
(`trainerId`) REFERENCES `trainers`
(`id`),
  CONSTRAINT `pt_registrations_ibfk_3` FOREIGN KEY
(`packageId`) REFERENCES `pt_packages`
(`id`),
  CONSTRAINT `pt_registrations_ibfk_4` FOREIGN KEY
(`paymentId`) REFERENCES `payments`
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE training_sessions (
  `id` int
(11) NOT NULL AUTO_INCREMENT,
  `ptRegistrationId` int
(11) NOT NULL,
  `sessionDate` datetime NOT NULL,
  `status` enum
('SCHEDULED','COMPLETED','CANCELLED','NO_SHOW') NOT NULL DEFAULT 'SCHEDULED',
...
UPDATE current_timestamp(),
  PRIMARY KEY
(`id`),
  KEY `ptRegistrationId`
(`ptRegistrationId`),
  CONSTRAINT `training_sessions_ibfk_1` FOREIGN KEY
(`ptRegistrationId`) REFERENCES `pt_registrations`
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(`id`),
  KEY `userId`
(`userId`),
  CONSTRAINT `check_ins_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `users`
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(`id`),
  KEY `userId`
(`userId`),
  CONSTRAINT `progress_tracking_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `users`
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(15,2) NOT NULL,
  `status` enum
('ACTIVE','MAINTENANCE','BROKEN','RETIRED') NOT NULL,
...
(`id`),
  KEY `equipmentId`
(`equipmentId`),
  CONSTRAINT `maintenance_logs_ibfk_1` FOREIGN KEY
...
(255) NOT NULL,
  ...
  `type` enum
('NEWS','PROMOTION','MAINTENANCE','OTHER') NOT NULL,
  `startDate` datetime NOT NULL,
  `endDate` datetime DEFAULT NULL,
  `status` enum
('DRAFT','PUBLISHED','ARCHIVED') NOT NULL,
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp
(),
  PRIMARY KEY
(`id`)
...
(4) NOT NULL,
  ...
  `status` enum
('ACTIVE','OFF') NOT NULL DEFAULT 'ACTIVE',
  PRIMARY KEY
(`id`),
  KEY `trainerId`
(`trainerId`),
  CONSTRAINT `schedules_ibfk_1` FOREIGN KEY
(`trainerId`) REFERENCES `trainers`
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(`id`),
    KEY `equipment_id`
(`equipment_id`),
    CONSTRAINT `equipment_images_ibfk_1` FOREIGN KEY
...
ADD INDEX idx_trainer_search (fullName, specialization
(100), status);
...
AFTER
UPDATE ON membership_registrations
FOR EACH ROW
BEGIN
...
-- Views
CREATE VIEW membership_revenue_report
AS
  SELECT
...
CREATE VIEW trainer_performance
AS
  SELECT
    t.id as trainer_id,
